...
public class AppService {
    ...
    private AppService(HttpClient httpClient) {
    ...
    public static class Builder {
        ...
        public AppService build() {
            return new AppService(httpClient);
        }
    }
     ...
     */
    public APPResponse prepay(PrepayRequest request) {
        String requestPath = "https://api.jitepay.com/v1/pay/transactions/app";
        String response = httpClient.httpPost(requestPath, JSONObject.toJSONString(request));
        return JSONObject.parseObject(response, APPResponse.class);
    }
